    ...
    <form class="card" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs customtab2" role="tablist">
                @foreach($section->translate()->orderBy('lang')->get() as $index => $lang)
                    <li class="nav-item">
            ...
            <div class="tab-content">
                @foreach($section->translate()->orderBy('lang')->get() as $index => $tabout)
                    <div class="tab-pane p-20 @if($index === 0) active @endif" id="{{ $tabout->lang }}"
                        ...
                        @enderror
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="subtitle[]" id="subtitle" placeholder="Ad"
                                   maxlength="255" value="{{ $tabout->subtitle }}" required/>
            ...
            <div class="mb-3">
                ...
                <input type="file" name="image" id="image" class="dropify" data-show-remove="false"
                       ...
                       data-default-file="{{ asset(Storage::url($section->image)) }}"/>
            </div>
            @error('image')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
